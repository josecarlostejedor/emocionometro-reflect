...
# Ocultamos absolutamente todo rastro de Streamlit
st.markdown("""
    <style>
...
# Esto permite que los botones del HTML hablen con Python
...
if "reset" in query and query["reset"] == "true":
    reset_db()
    st.query_params.clear()
    st.rerun()

current_view = query.get("view", "vote")
...
# --- 5. RENDERIZADO DE LA INTERFAZ ESPECTACULAR ---
def render_ui():
    ...
    <body>
        ...
        <script>
            ...
            function changeView(view) {{
                // Cambiamos la URL del padre (Streamlit) para navegar
            ...
            function vote(id) {{
                // Enviamos el voto a través de la URL
                const url = new URL(window.parent.location.href);
